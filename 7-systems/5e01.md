...
由Euly创造的一个虚拟声音芯片.基于理光2A03,有以下提升a fantasy sound chip created by Euly, based on the Ricoh 2A03, with some improvements:

- 37.5%占空比a 37.5% duty cycle,
- 32个32 noise pitches instead of 16, and
- 三角波通道变成一个波形通道,有4个可用的波形:三角波,锯齿波,正弦波,方波.triangle channel becomes a wave channel, with four available waveforms: triangle, saw, sine and square.
